...
def get_seg_model(train=False):
    from model.FIDTM.default import _C as hr_config
    from model.FIDTM.default import update_config

    update_config(hr_config, './model/FIDTM/seg_hrnet_w48.yaml')
    model = HighResolutionNet(hr_config)
    from model.FIDTM.config import cfg
